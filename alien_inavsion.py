...
class AlienInvasion:
   ...
   def __init__(self):
      ...
      self.sb = Scoreboard(self) # and create a scoreboard.
      self.ship = Ship(self)
   ...
   def _check_play_button(self, mouse_pos):
      ...
      if button_clicked and not self.game_active:
         self.settings.initialize_dynamic_settings() # Reset the game statistics.
   ...
   def _update_aliens(self):
      ...
      self.aliens.update()
      if pygame.sprite.spritecollideany(self.ship, self.aliens): # Look for alien-ship collisions.
         self._ship_hit()
   ...
   def _create_fleet(self):
      ...
      # Spacing between aliens is one alien widthand one alien height.
   ...
   def _update_screen(self):
      ...
      self.sb.show_score()
      if not self.game_active:# Draw the play button if the game is inactive.
